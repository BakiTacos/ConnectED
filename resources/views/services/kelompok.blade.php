...
{{-- Include CSS yang sama agar konsisten --}}
<style>
    /* CSS SERVICE & HERO */
...
<div class="service-bg-blue">
    <div class="hero-wrapper">
        <img src="https://images.unsplash.com/photo-1531206715517-5c0ba140b2b8?q=80" class="hero-bg-img">
        <div class="hero-content-text">
            <div class="hero-title">Kelompok</div>
            <div class="hero-desc">Konseling yang akan dilakukan secara kelompok dengan psikolog langsung.</div>
        </div>
    </div>
</div>
...
<div class="overlap-cards">
    <div class="cards-grid">
        <div class="info-card">
            <div class="card-title">Hubungan Asmara</div>
            ...
            <ul class="card-list">
                <li>Komunikasi yang macet atau sering bertengkar.</li>
                <li>Terjebak dalam Toxic Relationship.</li>
                <li>Masalah kepercayaan (trust issue).</li>
            </ul>
        </div>
        <div class="info-card">
            <div class="card-title">Dinamika Pertemanan</div>
            <div class="card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M18 9h2a2 2 0 0 1 2 2v11l-4-4h-6a2 2 0 0 1-2-2v-1"></path><path d="M12 11V9a2 2 0 0 1 2-2h2"></path><path d="M8 21v-6a2 2 0 0 1 2-2h2"></path></svg></div>
            <div class="card-divider"></div>
            <ul class="card-list">
                <li>Konflik dengan teman sekost atau se-geng.</li>
                <li>Merasa dimanfaatkan atau diasingkan.</li>
                <li>Kesalahpahaman yang berlarut-larut.</li>
            </ul>
        </div>
        <div class="info-card">
            <div class="card-title">Rekan Tim & Organisasi</div>
            ...
            <div class="card-divider"></div>
            <ul class="card-list">
                <li>Konflik dalam tugas kelompok atau skripsi.</li>
                <li>Masalah kepanitiaan atau organisasi.</li>
                <li>Ketidakcocokan gaya kerja antar anggota.</li>
            </ul>
        </div>
    </div>

    {{-- TESTIMONI SECTION (SAMA) --}}
    <div class="testimoni-wrapper">
        ...
        <div class="testi-grid">
            <div class="testi-card">
                <div class="testi-header"><div class="avatar-circle">MJ</div><div class="testi-role">e-Counseling</div></div>
            ...
            <div class="testi-card">
                <div class="testi-header"><div class="avatar-circle">AL</div><div class="testi-role">Counseling</div></div>
            ...
            <div class="testi-card">
                <div class="testi-header"><div class="avatar-circle">KV</div><div class="testi-role">e-Counseling</div></div>
